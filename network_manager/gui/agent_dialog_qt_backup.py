...
class ANCSAgentDialog(QDialog):
    ...
    def _build_sub_header(self):
        ...
        self._btn_connect.setFixedHeight(24)
    ...
    def _restore_state(self):
        ...
        idx_map = {"openrouter": 0, "gemini": 1, "vertex": 2, "hapuppy": 3, "nvidia": 4}
    ...
    def _stop_worker(self):
        if self.app._copilot_worker is not None:
            ...
            # Prevent QThread from being destroyed while still running (which crashes PySide6 silently)
    ...
    def _toggle_connection(self):
        if self._is_worker_alive():
            ...
            self._model_badge.setText("Not connected")
        else:
            if hasattr(self, "_btn_connect"):
    ...
    def _launch_agent(self):
        ...
        provider_map = {0: "openrouter", 1: "gemini", 2: "vertex", 3: "hapuppy", 4: "nvidia"}
